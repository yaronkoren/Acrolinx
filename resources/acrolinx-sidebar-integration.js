...
var MultiEditorAdapter = (function () {
    ...
    MultiEditorAdapter.prototype.remapMatches = function (matches) {
        ...
        for (var _i = 0, matches_1 = matches; _i < matches_1.length; _i++) {
            ...
            var rangeInsideWrapper = [match.range[0] - (checkedRangeStart), match.range[1] - (checkedRangeStart)];
...
exports.FOOTER = 'acrolinxFloatingSidebarFooter';
...
var SidebarURLInvalidError = (function (_super) {
    ...
    function SidebarURLInvalidError(message, configuredSidebarURL, htmlLoaded) {
        ...
        _this.configuredSidebarURL = configuredSidebarURL;
        _this.htmlLoaded = htmlLoaded;
        _this.configuredSidebarURL = configuredSidebarURL;
        _this.htmlLoaded = htmlLoaded;
        _this.details = message + "\n" +
    ...
    return concatTextMappings(_.map(node.childNodes, function (child) {
        switch (child.nodeType) {
            ...
            case Node.TEXT_NODE:
                ...
                if (textContent) {
                    return textMapping(textContent, _.times(textContent.length, function (i) { return domPosition(child, i); }));
                }
                else {
                    return EMPTY_TEXT_DOM_MAPPING;
                }
